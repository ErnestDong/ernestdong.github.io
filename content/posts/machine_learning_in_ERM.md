...
```text
<AxesSubplot:>
findfont: Font family ['VictorMono Nerd Font Mono'] not found. Falling back to DejaVu Sans.
```

{{< figure src="/ox-hugo/3d35918888125caf7bec2a135968b47e5e1dc2e2.png" >}}
...
|           |   |                     |        |   |                    |    |   |                   |           |   |                       |
|-----------|---|---------------------|--------|---|--------------------|----|---|-------------------|-----------|---|-----------------------|
| precision | : | 0.23386814832079544 | recall | : | 0.1247047244094488 | f1 | : | 0.153354350561997 | \\(R^2\\) | : | -0.008535928795618913 |
...
|           |   |                    |        |   |                    |    |   |                    |           |   |                   |
|-----------|---|--------------------|--------|---|--------------------|----|---|--------------------|-----------|---|-------------------|
| precision | : | 0.4066905195292156 | recall | : | 0.4330708661417323 | f1 | : | 0.3815005456974773 | \\(R^2\\) | : | 0.368374436514266 |
...
|           |   |                    |        |   |                    |    |   |                    |           |   |                    |
|-----------|---|--------------------|--------|---|--------------------|----|---|--------------------|-----------|---|--------------------|
| precision | : | 0.5282406698367763 | recall | : | 0.5216535433070866 | f1 | : | 0.5045549085578276 | \\(R^2\\) | : | 0.5309433463153391 |
...
-  梯度下降与反向传播
    ...
    ```text
    1.1642124652862549 0.9168747067451477 84.5
    4.111670017242432 7.39219331741333 0.10347766429185867
    3.810821533203125 7.563225269317627 0.05462425574660301
    3.5894083976745605 7.6825032234191895 0.028864456340670586
    3.4284543991088867 7.769204139709473 0.015252453275024891
    3.3114540576934814 7.832228660583496 0.008059692569077015
    3.2264034748077393 7.878043174743652 0.004258899949491024
    3.164578914642334 7.911346435546875 0.0022504981607198715
    3.119636058807373 7.935555458068848 0.0011892016045749187
    3.0869667530059814 7.95315408706665 0.0006284001865424216
    ```
...
epoch: 300 loss: 0.10917149484157562
epoch: 600 loss: 0.10904917120933533
epoch: 900 loss: 0.09919081628322601
epoch: 1200 loss: 0.09025489538908005
epoch: 1500 loss: 0.08482387661933899
epoch: 1800 loss: 0.0825016051530838
epoch: 2100 loss: 0.07796560972929001
epoch: 2400 loss: 0.07534132897853851
epoch: 2700 loss: 0.07218263298273087
```

|           |   |                     |        |   |                     |    |   |                   |           |   |                    |
|-----------|---|---------------------|--------|---|---------------------|----|---|-------------------|-----------|---|--------------------|
| precision | : | 0.36140370442997377 | recall | : | 0.39763779527559057 | f1 | : | 0.378069780663654 | \\(R^2\\) | : | 0.3339467605342995 |
...
|-------------------|-----------|--------|--------|-----------|
| random            | 0.2339    | 0.1247 | 0.1534 | -0.0085   |
| logit             | 0.1753    | 0.2402 | 0.1529 | -0.0174   |
| decision tree     | 0.3499    | 0.3799 | 0.3529 | 0.3632    |
| random forest     | 0.4067    | 0.4331 | 0.3815 | 0.3684    |
| gradient boosting | 0.5282    | 0.5217 | 0.5046 | 0.5309    |
...
| RNN               | 0.3614    | 0.3976 | 0.3781 | 0.3339    |
...
{{< figure src="/ox-hugo/662acb2b50e620609d411c717be2b22784451627.png" >}}
