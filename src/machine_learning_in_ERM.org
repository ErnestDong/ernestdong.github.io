...
:RESULTS:
: <AxesSubplot:>
[[file:./.ob-jupyter/3d35918888125caf7bec2a135968b47e5e1dc2e2.png]]
:END:
...
[["model", "precision", "recall", "f1"]]+list([i[0]]+ [round(j,4) for j in i[1].values()] for i in result.items())
#+end_src

#+RESULTS:
| model             | precision | recall |     f1 |
| random            |    0.2269 | 0.1246 | 0.1516 |
| logit             |    0.1842 | 0.2463 |  0.158 |
| decision tree     |    0.3678 | 0.4064 | 0.3624 |
| random forest     |    0.3895 | 0.4089 | 0.3509 |
| gradient boosting |    0.5125 | 0.5172 | 0.5022 |
| svm               |    0.3872 | 0.3941 | 0.3311 |
| bp neural network |    0.2527 |  0.335 | 0.2415 |
| CNN               |    0.4399 | 0.4754 | 0.4509 |
#+begin_src jupyter-python
...
#+RESULTS:
[[file:./.ob-jupyter/b60b575975c925c99be0e79b9f8d3c52c5d63828.png]]
